...
class shape2:
    def __init__(self, a, vb, sp = Point(0, 0), skalar_a = 1, skalar_b = 1) -> None:
        self.a = a
...
def punktprobe(point, area):
    ...
    x = 0
    y = (area.a.x * area.b.y - area.a.x * area.b.x)
    d = x * area.sp.x + y * area.sp.y
    return d == point.x * y - point.y * x

def intersect2(b : Building, bb, DIFF = 50) -> bool:
